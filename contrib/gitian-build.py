...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/dmitry9888/gitian.sigs.git'])
    if not os.path.isdir('falcon-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/dmitry9888/falcon-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('falcon-core'):
        subprocess.check_call(['git', 'clone', 'https://github.com/dmitry9888/falcon.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/dmitry9888/falcon', help='Specify the URL of the repository. Default is %(default)s')
