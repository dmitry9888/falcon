...
def setup():
    ...
    if not os.path.isdir('falcon-core'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ProjectFalcon/falcon.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/ProjectFalcon/falcon', help='Specify the URL of the repository. Default is %(default)s')
