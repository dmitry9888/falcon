...
VERSION=
commit=false
url=https://github.com/ProjectFalcon/falcon-core
proc=2
mem=3000
lxc=true
docker=false
...
-u|--url        Specify the URL of the repository. Default is https://github.com/ProjectFalcon/falcon-core
...
then
    ...
    git clone https://github.com/ProjectFalcon/gitian.sigs
    git clone https://github.com/ProjectFalcon/falcon-detached-sigs
